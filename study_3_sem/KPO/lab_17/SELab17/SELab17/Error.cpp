...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(90, "Лексический анализатор: идентификатор не распознан"),						// +
		ERROR_ENTRY(91, "Лексический анализатор: строковый литерал превышает допустимый размер"),	// +
		ERROR_ENTRY_NODEF(92),
		ERROR_ENTRY(93, "Лексический анализатор: строковый литерал не распознан"),					// +
		...
		ERROR_ENTRY(98, "Отсутствует закрывающая или открывающая фигурные скобки '{' '}'"),			// +
		ERROR_ENTRY(99, "Отсутствует закрывающая или открывающая скобки '(' ')'"),					// +
