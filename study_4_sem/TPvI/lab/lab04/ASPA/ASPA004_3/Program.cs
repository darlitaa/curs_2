...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        using (IRepository repository = Repository.Create(@"D:\curs_2\study_4_sem\“ѕв»\lab\lab04\ASPA\ASPA004_3\Celebrities"))
        {
            ...
            app.Map("/Celebrities/Error", (HttpContext ctx) =>
            {
                ...
                if (ex != null)
                {
                    ...
                    if (ex is InvalidPhotoPathException)    rc = Results.Problem(title: "ASPA004", detail: ex.Message, instance: app.Environment.EnvironmentName, statusCode: 500);
                    if (ex is DelByIdException)             rc = Results.NotFound(ex.Message);
                    if (ex is UpdException)                 rc = Results.Problem(ex.Message);
                }
                return rc;
            });
