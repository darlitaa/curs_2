...
BEGIN 
	INSERT #MyTable
	VALUES (@a, 'LINE' + CAST(@a AS varchar(20)))
	SET @a += 1;
END

SELECT COUNT(*)[ÊÎËÈ×ÅÑÒÂÎ ÑÒÐÎÊ] FROM #MyTable
SELECT * FROM #MyTable
...
SELECT COUNT(*)[ÊÎËÈ×ÅÑÒÂÎ ÑÒÐÎÊ] FROM #MyTable2;
...
SELECT COUNT(*)[ÊÎËÈ×ÅÑÒÂÎ ÑÒÐÎÊ] FROM #MyTable3
...
SELECT COUNT(*)[ÊÎËÈ×ÅÑÒÂÎ ÑÒÐÎÊ] FROM #MyTable4
...
SELECT COUNT(*)[ÊÎËÈ×ÅÑÒÂÎ ÑÒÐÎÊ] FROM #MyTable5
...
SELECT COUNT(*)[ÊÎËÈ×ÅÑÒÂÎ ÑÒÐÎÊ] FROM #MyTable6
